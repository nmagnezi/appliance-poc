...
skopeo copy dir:/mnt/sr1/images/ose-agent-installer-node-agent docker://${ASSISTED_INSTALLER_AGENT_IMAGE/quay.io/0.0.0.0:5000} --dest-tls-verify=false
skopeo copy dir:/mnt/sr1/images/ose-agent-installer-api-server docker://${ASSISTED_SERVICE_IMAGE/quay.io/0.0.0.0:5000} --dest-tls-verify=false
